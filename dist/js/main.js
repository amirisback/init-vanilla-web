...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('%c⚡ Vanilla Web + Tailwind CSS v4 + TypeScript', 'color: #818cf8; font-size: 14px; font-weight: bold; background: #0f172a; padding: 6px 12px; border-radius: 6px;');
